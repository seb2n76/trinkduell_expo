...
// Für die Admin-Konsole gibt es hier bewusst KEINE lokalen Helfer.
// Sie existierte kurzzeitig mit Offline-Rückfall: "Nutzer gesperrt"
// meldete Erfolg, ohne irgendwo zu sperren, und das Dashboard zeigte
// erfundene Serverwerte. Eine Moderationsansicht muss Serverzustand
// zeigen oder ehrlich sagen, dass sie ihn nicht erreicht.
// Siehe den Kommentar am Admin-Block in services/api.ts.
